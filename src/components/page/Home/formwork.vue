            ...
            <div class="main_search">
                <div class="search_list">
                    ...
                    <el-radio-group v-model="radio1">
                        <el-radio-button v-for="(item,index) in radioList1.arr" :key="index" :label="item"></el-radio-button>
                    </el-radio-group>
                </div>
                <div class="search_list">
                    <label class="label">{{ radioList2.label }}</label>
                    <el-radio-group v-model="radio2">
                        <el-radio-button v-for="(item,index) in radioList2.arr" :key="index" :label="item"></el-radio-button>
                    </el-radio-group>
                </div>
                <div class="search_list">
                    <label class="label">{{ radioList3.label }}</label>
                    <el-radio-group v-model="radio3">
                        <el-radio-button v-for="(item,index) in radioList3.arr" :key="index" :label="item"></el-radio-button>
                    </el-radio-group>
                </div>
            </div>
